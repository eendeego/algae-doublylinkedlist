...
(function (exports) {
  ...
  function create(initializer) {
    ...
    list.set = function (index, newValue) {
      if (index < 0) {
        index = size + index;
      }
      ...
      var oldValue = bucket.target;

      bucket.target = newValue;
    ...
    list.last = function () {
      ...
      return head.previous.target;
    }

    list.penultimate = function () {
      if (size === 0) {
        return undefined;
      }

      return head.previous.previous.target;
    }
